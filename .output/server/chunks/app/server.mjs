import { version, ref, watchEffect, watch, getCurrentInstance, hasInjectionContext, unref, inject, useSSRContext, createApp, effectScope, reactive, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, shallowReactive, isReadonly, computed, defineAsyncComponent, isRef, isShallow, isReactive, toRaw, withCtx, mergeProps, nextTick, defineComponent, h, Suspense, Transition } from 'vue';
...
const hr = Symbol.toStringTag, oi = n((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[hr] === "URLSearchParams", "isURLSearchParameters"), pr = n((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[hr]), "isBlob"), bs = n((i) => typeof i == "object" && (i[hr] === "AbortSignal" || i[hr] === "EventTarget"), "isAbortSignal"), ms = n((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a2 } = await import('./_nuxt/multipart-parser-c0d6ae1b.mjs');
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-aa02d65e.mjs').then((m) => m.default || m)
  }
];
...
const colors_XCtZw8YsGx = /* @__PURE__ */ defineNuxtPlugin(() => {
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.8.0_vite@4.5.0/node_modules/nuxt/dist/pages/runtime/app.vue");
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-dff5c95e.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-1594d7e9.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, parseQuery as a, withoutTrailingSlash as b, createError as c, navigateTo as d, entry$1 as default, useHead as e, dr as f, wn as g, hasProtocol as h, createTailwindMerge as i, getDefaultConfig as j, useAppConfig as k, appConfig as l, mergeConfig as m, nuxtLinkDefaults as n, parseURL as p, twJoin as t, useRouter as u, withTrailingSlash as w };
